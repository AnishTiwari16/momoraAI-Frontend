...
const StarWarsButton: React.FC = () => {
    ...
    return (
        <motion.button
            ref={buttonRef}
            className="mx-auto flex items-center justify-center text-md relative overflow-hidden rounded-full border-2 border-yellow-400 bg-black px-8 py-2.5 font-semibold text-yellow-400 focus:outline-none"
            style={{
                boxShadow:
